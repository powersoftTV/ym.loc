...
<?php 
                        ...
                        echo '<div class="post small">
								<a href="?page=post_gallery" title="'.$row['r_title_hy'.$lang].'">
									<span class="icon gallery"></span>
									<img src="'.$domen.'userfiles/'.$row['r_pic'].'" alt="img">
								</a>
								<div class="slider_content_box">
									<ul class="post_details simple">
										<li class="category"><a title="'.$row['c_name_'.$lang].'" href="?page=category&amp;cat=lifestyle">'.$row['c_name_'.$lang].'</a></li>
									</ul>
									<h5><a href="?page=post" title="'.$row['r_title_'.$lang].'">'.mb_substr($row['r_title_'.$lang], 0, 45,'utf-8').'...</a></h5>
								</div>
							</div>';
                  /*  echo '    
					<li class="slide">
						<a href="?page=post" title="'.$row['r_title_hy'.$lang].'">
						...
						<div class="slider_content_box">
							...
							<!--<div class="post medium">
								<a href="?page=post_gallery" title="Nuclear Fusion Closer to Becoming a Reality">
									<span class="icon gallery"></span>
									<img src='images/samples/524x261/image_10.jpg' alt='img'>
								</a>
								<div class="slider_content_box">
									<ul class="post_details simple">
										<li class="category"><a title="WORLD" href="?page=category&amp;cat=world">WORLD</a></li>
									</ul>
									<h2><a href="?page=post_gallery" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a></h2>
								</div>
							</div>
							<div class="post medium">
						...
						<div class="row">
							<div class="post medium">
								<a href="?page=post" title="Escape From Planet Earth: The Movie">
									<img src='images/samples/524x261/image_05.jpg' alt='img'>
								</a>
								<div class="slider_content_box">
									<ul class="post_details simple">
										<li class="category"><a title="WORLD" href="?page=category&amp;cat=world">WORLD</a></li>
									</ul>
									<h2><a href="?page=post" title="Escape From Planet Earth: The Movie">Escape From Planet Earth: The Movie</a></h2>
								</div>
							</div>
					...
					<div class="slider_view">
						<ul class="small_slider">
							...
							<li class="slide">
								<a href="?page=post_quote_2" title="Bayern Says Ties With Rivals Dortmund Have Frozen">
								...
								<div class="slider_content_box">
									...
									<h2><a href="?page=post_quote_2" title="Bayern Says Ties With Rivals Dortmund Have Frozen">Bayern Says Ties With Rivals Dortmund Have Frozen</a></h2>
								</div>
							</li>
							<li class="slide">
								...
								<div class="slider_content_box">
									...
									<h2><a href="?page=post_small_image" title="Escape From Planet Earth: The Movie">Escape From Planet Earth: The Movie</a></h2>
								</div>
							</li>
							<li class="slide">
		...
		<div class="row page_margin_top">
			<div class="column column_2_3">
				...
				<div class="row page_margin_top_section">
					<h4 class="box_header">Featured Posts</h4>
					<div class="tabs no_scroll margin_top_10 clearfix">
							...
							<div class="horizontal_carousel_container page_margin_top">
								<ul class="blog horizontal_carousel page_margin_top autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
									<li class="post">
										...
										<h5><span class="number">1.</span><a href="?page=post_review_2" title="High Altitudes May Aid Weight Control">High Altitudes May Aid Weight Control</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
											<li class="date">
												10:11 PM, Feb 02
									...
									<li class="post">
										<a href="?page=post_review" title="Climate Change Debate While Britain Floods">
											<span class="icon"><span>8.2</span></span>
											<img src='images/samples/330x242/image_14.jpg' alt='img'>
										</a>
										<h5><span class="number">2.</span><a href="?page=post_review" title="Climate Change Debate While Britain Floods">Climate Change Debate While Britain Floods</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
											<li class="date">
												10:11 PM, Feb 02
									...
									<li class="post">
										<a href="?page=post_review_2" title="Escape From Planet Earth: The Movie">
											<span class="icon"><span>6.5</span></span>
											<img src='images/samples/330x242/image_02.jpg' alt='img'>
										</a>
										<h5><span class="number">3.</span><a href="?page=post_review_2" title="Escape From Planet Earth: The Movie">Escape From Planet Earth: The Movie</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=lifestyle" title="LIFESTYLE">LIFESTYLE</a></li>
											<li class="date">
												10:11 PM, Feb 02
									...
									<li class="post first">
										<a href="?page=post_review" title="Built on Brotherhood, Club Lives Up to Name">
											<span class="icon"><span>6.2</span></span>
											<img src='images/samples/330x242/image_09.jpg' alt='img'>
										</a>
										<h5><span class="number">4.</span><a href="?page=post_review" title="Built on Brotherhood, Club Lives Up to Name">Built on Brotherhood, Club Lives Up to Name</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=sports" title="SPORTS">SPORTS</a></li>
											<li class="date">
												10:11 PM, Feb 02
						...
						<div id="top-rated">
							<div class="horizontal_carousel_container page_margin_top">
								<ul class="blog horizontal_carousel page_margin_top autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
									<li class="post">
										<a href="?page=post_soundcloud" title="The Public Health Crisis Hiding in Our Food">
											<img src='images/samples/330x242/image_10.jpg' alt='img'>
										</a>
										<h5><span class="number">1.</span><a href="?page=post_soundcloud" title="The Public Health Crisis Hiding in Our Food">The Public Health Crisis Hiding in Our Food</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
											<li class="date">
												10:11 PM, Feb 02
									...
									<li class="post">
										<a href="?page=post_quote" title="Drug Makers Hunt for Mergers">
											<img src='images/samples/330x242/image_07.jpg' alt='img'>
										</a>
										<h5><span class="number">2.</span><a href="?page=post_quote" title="Drug Makers Hunt for Mergers">Drug Makers Hunt for Mergers</a></h5>
										<ul class="post_details simple">
											<li class="category"><a href="?page=category&amp;cat=world" title="WORLD">WORLD</a></li>
											<li class="date">
												10:11 PM, Feb 02
				...
				<div class="row page_margin_top_section">
					<div class="column column_1_2">
						...
						<ul class="blog">
							<li class="post">
								<a href="?page=post_small_image" title="Struggling Nuremberg Sack Coach Verbeek">
									<img src='images/samples/330x242/image_06.jpg' alt='img'>
								</a>
								<h2 class="with_number">
									<a href="?page=post_small_image" title="Struggling Nuremberg Sack Coach Verbeek">Struggling Nuremberg Sack Coach Verbeek</a>
			...
			<div class="column column_1_3">
				...
				<ul class="list">
					...
					<li class="bullet style_1"><a href="?page=post_quote" title="Nuclear Fusion Closer to Becoming a Reality">Nuclear Fusion Closer to Becoming a Reality</a></li>
				</ul>
				...
				<div class="row">
					...
					<div class="column column_1_2">
						<ul class="blog small clearfix">
							...
							<li class="post">
								<a href="?page=post_small_image" title="Seeking the Right Chemistry, Drug Makers Hunt for Mergers">
									<img src='images/samples/100x100/image_13.jpg' alt='img'>
								</a>
								<div class="post_content">
									<h5>
										<a href="?page=post_small_image" title="Seeking the Right Chemistry, Drug Makers Hunt for Mergers">Seeking the Right Chemistry, Drug Makers Hunt for Mergers</a>
									</h5>
									<ul class="post_details simple">
										<li class="category"><a href="?page=category&amp;cat=health" title="HEALTH">HEALTH</a></li>
										<li class="date">
