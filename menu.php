<nav>
<ul class="sf-menu">
	<li class="submenu<?php echo ($_GET["page"]=="" || $_GET["page"]=="home" || $_GET["page"]=="home_2" || $_GET["page"]=="home_3" || $_GET["page"]=="home_4" || $_GET["page"]=="home_5" || $_GET["page"]=="home_6" || $_GET["page"]=="home_7" ? " selected" : ""); ?>">
		<a href="#" title="Home">
			Home
		</a>
		<ul>
			...
			<li<?php echo ($_GET["page"]=="home_6" ? " class='selected'" : ""); ?>>
				<a href="?page=home_6" title="Home Style 6">
					Home Style 6
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="home_7" ? " class='selected'" : ""); ?>>
	...
	<li class="submenu<?php echo ($_GET["page"]=="about" || $_GET["page"]=="about_2" || $_GET["page"]=="default" || $_GET["page"]=="shortcodes" || $_GET["page"]=="404" ? " selected" : ""); ?>">
		<a href="#" title="Pages">
			Pages
		</a>
		<ul>
			...
			<li<?php echo ($_GET["page"]=="about_2" ? " class='selected'" : ""); ?>>
				<a href="?page=about_2" title="About Style 2">
					About Style 2
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="default" ? " class='selected'" : ""); ?>>
	...
	<li class="submenu<?php echo ($_GET["page"]=="post" || $_GET["page"]=="post_gallery" || $_GET["page"]=="post_small_image" || $_GET["page"]=="post_video" || $_GET["page"]=="post_video_2" || $_GET["page"]=="post_soundcloud" || $_GET["page"]=="post_review" || $_GET["page"]=="post_review_2" || $_GET["page"]=="post_quote" || $_GET["page"]=="post_quote_2" ? " selected" : ""); ?>">
		...
		<ul>
			...
			<li<?php echo ($_GET["page"]=="post_gallery" ? " class='selected'" : ""); ?>>
				<a href="?page=post_gallery" title="Post Gallery">
					Post Gallery
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_small_image" ? " class='selected'" : ""); ?>>
				<a href="?page=post_small_image" title="Post Small Image">
					Post Small Image
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_video" ? " class='selected'" : ""); ?>>
				<a href="?page=post_video" title="Post Video YouTube">
					Post Video Youtube
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_video_2" ? " class='selected'" : ""); ?>>
				<a href="?page=post_video_2" title="Post Video Vimeo">
					Post Video Vimeo
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_soundcloud" ? " class='selected'" : ""); ?>>
				<a href="?page=post_soundcloud" title="Post Soundcloud">
					Post Soundcloud
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_review" ? " class='selected'" : ""); ?>>
				<a href="?page=post_review" title="Post Review Style 1">
					Post Review Style 1
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_review_2" ? " class='selected'" : ""); ?>>
				<a href="?page=post_review_2" title="Post Review Style 2">
					Post Review Style 2
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_quote" ? " class='selected'" : ""); ?>>
				<a href="?page=post_quote" title="Post Quote Style 1">
					Post Quote Style 1
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="post_quote_2" ? " class='selected'" : ""); ?>>
	...
	<li class="submenu<?php echo ($_GET["page"]=="blog" || $_GET["page"]=="blog_small_slider" || $_GET["page"]=="blog_left_sidebar" || $_GET["page"]=="blog_2_columns" || $_GET["page"]=="blog_2_columns_left_sidebar" || $_GET["page"]=="blog_3_columns" || $_GET["page"]=="search" ? " selected" : ""); ?>">
		<a href="?page=blog" title="Blog">
			Blog
		</a>
		<ul>
			<li<?php echo ($_GET["page"]=="blog_small_slider" ? " class='selected'" : ""); ?>>
				<a href="?page=blog_small_slider" title="Blog Small Slider">
					Blog Small Slider
				</a>
			</li>
			<li class="submenu<?php echo ($_GET["page"]=="blog" || $_GET["page"]=="blog_left_sidebar" ? " selected" : ""); ?>">
			...
			<li class="submenu<?php echo ($_GET["page"]=="blog_2_columns" || $_GET["page"]=="blog_2_columns_left_sidebar" ? " selected" : ""); ?>">
	...
	<li class="submenu<?php echo ($_GET["page"]=="authors" || $_GET["page"]=="author" ? " selected" : ""); ?>">
		<a href="?page=authors" title="Authors">
			Authors
		</a>
		<ul>
			<li<?php echo ($_GET["page"]=="authors" ? " class='selected'" : ""); ?>>
				<a href="?page=authors" title="Authors List">
					Authors List
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="author" ? " class='selected'" : ""); ?>>
	...
	<li class="submenu<?php echo ($_GET["page"]=="category" && ($_GET["cat"]=="health" || $_GET["cat"]=="science" || $_GET["cat"]=="sports" || $_GET["cat"]=="world" || $_GET["cat"]=="lifestyle") ? " selected" : ""); ?>">
		<a href="#" title="Categories">
			Categories
		</a>
		<ul>
			<li<?php echo ($_GET["page"]=="category" && $_GET["cat"]=="health" ? " class='selected'" : ""); ?>>
				<a href="?page=category&amp;cat=health" title="Health">
					Health
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="category" && $_GET["cat"]=="science" ? " class='selected'" : ""); ?>>
				<a href="?page=category&amp;cat=science" title="Science">
					Science
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="category" && $_GET["cat"]=="sports" ? " class='selected'" : ""); ?>>
				<a href="?page=category&amp;cat=sports" title="Sports">
					Sports
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="category" && $_GET["cat"]=="world" ? " class='selected'" : ""); ?>>
				<a href="?page=category&amp;cat=world" title="World">
					World
				</a>
			</li>
			<li<?php echo ($_GET["page"]=="category" && $_GET["cat"]=="lifestyle" ? " class='selected'" : ""); ?>>
	...
	<li class="submenu<?php echo ($_GET["page"]=="contact" || $_GET["page"]=="contact_2" ? " selected" : ""); ?>">
