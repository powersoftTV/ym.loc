				...
				<div class="footer clearfix">
								...
								<ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
									<li class="post">
										<a href="?page=post_gallery" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">
											...
											<img src='<?=$domen?>images/samples/100x100/image_06.jpg' alt='img'>
										</a>
									...
									<li class="post">
										<a href="?page=post" title="Nuclear Fusion Closer to Becoming a Reality">
											<img src='<?=$domen?>images/samples/100x100/image_13.jpg' alt='img'>
										</a>
										<div class="post_content">
											<h5>
								...
								<ul class="blog horizontal_carousel visible-1 autoplay-0 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
									...
									<li class="post">
										<a href="?page=post_gallery" title="Built on Brotherhood, Club Lives Up to Name">
											<span class="icon gallery"></span>
											<img src='<?=$domen?>images/samples/330x242/image_14.jpg' alt='img'>
										</a>
										<h5 class="with_number">
					...
					<div class="row copyright_row">
						<div class="column column_2_3">
							© Copyright <a href="http://quanticalabs.com" title="QuanticaLabs" target="_blank">QuanticaLabs</a> - PressRoom Template. <a href="http://themeforest.net/user/QuanticaLabs/portfolio?ref=QuanticaLabs" title="PressRoom Template" target="_blank">Click here to buy it</a> 
						</div>
						<div class="column column_1_3">
							<ul class="footer_menu">
								<li>
		...
		<!--js-->
		<script type="text/javascript" src="<?=$domen?>js/jquery-1.11.1.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.ba-bbq.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery-ui-1.11.1.custom.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.easing.1.3.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.carouFredSel-6.2.1-packed.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.touchSwipe.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.transit.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.sliderControl.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.timeago.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.hint.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.prettyPhoto.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.qtip.min.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/jquery.blockUI.js"></script>
		<script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript" src="<?=$domen?>js/main.js"></script>
		<script type="text/javascript" src="<?=$domen?>js/odometer.min.js"></script>
		<?php
